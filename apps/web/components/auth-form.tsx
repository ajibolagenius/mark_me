...
import { Logo, Field, MOCK_USERS } from "@markme/ui";
...
export function AuthForm({ mode }: { mode: "login" | "signup" }) {
  ...
  return (
    <>
      ...
      <main
        id="main-content"
        className="relative z-1 flex flex-1 items-center justify-center p-5"
      >
        <motion.div
        ...
        >
              ...
              <div className="mb-[18px] border border-mm-secondary/20 bg-mm-secondary-subtle p-3">
                ...
                <div className="grid grid-cols-2 gap-[6px]">
                  {Object.entries(MOCK_USERS).map(([em, u]) => (
                    ...
                    >
                      <span className="text-[11px] font-bold text-mm-text">
                        {u.name}
                      </span>
                      <span className="font-mono text-[10px] text-mm-text-muted">
                        {em}
                      </span>
                      <span
          ...
          <button
            onClick={() => {
              setGLoading(true);
              setTimeout(() => setGLoading(false), 2000);
            }}
            disabled={gLoading}
